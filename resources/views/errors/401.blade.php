          ...
          <div class="row">
            ...
            <div class="col-lg-10">
              <div class="row align-items-center">
                <div class="col-md-5 col-sm-12 mb-30 text-center text-md-start"><img src="{{ asset('asset/frontend//imgs/page/404/404.png') }}" alt="iori"></div>
                <div class="col-md-7 col-sm-12 text-center text-md-start">
                  <h1 class="color-brand-1 font-84 mb-10 wow animate__animated animate__fadeIn" data-wow-delay=".0s">401</h1>
                  ...
                  <div class="mt-50 wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a class="btn btn-default color-grey-900 pl-0" href="javascript:history.back();">
