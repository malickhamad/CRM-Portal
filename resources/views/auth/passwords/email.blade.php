    ...
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div class="text-center">
                ...
                <h4 class="mb-12 color-brand-1">Forgot Password</h4>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="mb-16">
                    <div class="icon-field">
                     ...
                     @error('email')
                            <span class="invalid-feedback mt-1 d-block">{{ $message }}</span>
                        @enderror
                </div>
                <button type="submit" class="btn btn-brand-1-full text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32">Send Reset Link</button>

                <div class="mt-32 text-center text-sm">
                    <a href="{{ route('login') }}" class=" fw-semibold color-brand-1">Back to Sign In</a>
                </div>
            </form>
