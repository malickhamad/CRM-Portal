    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0 text-success-1000">Permissions</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium text-success-1000 text-md">Permissions</li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title text-success-1000">Add Permission</h4>
                            <a href="{{ route('admin.permissions.create') }}" class="btn btn-brand-1">+ Add
                                </a>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($permissions as $key => $permission)
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    {{ optional($permission->created_at)->format('Y-m-d') }}
                                                </td>
