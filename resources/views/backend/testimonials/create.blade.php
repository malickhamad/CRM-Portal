...
<main class="dashboard-main">
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0 text-success-1000">Testimonials Create</h6>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 col-lg-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control  form-control-sm @error('name') is-invalid @enderror"
                                            id="name" value="{{ old('name') }}" placeholder="Enter client name" required />
                                        @error('name')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="testimonial_detail" class="form-control  form-control-sm @error('testimonial_detail') is-invalid @enderror"
                                            id="editor" placeholder="Enter testimonial testimonial_detail" required>{{ old('testimonial_detail') }}</textarea>
                                        @error('message')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="image" class="form-label">Client Image (optional)</label>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-brand-1 float-start">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
