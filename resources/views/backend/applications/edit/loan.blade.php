            ...
            <div class="container-fluid bg-white px-3 py-5">
                ...
                <form id="applicationForm" action="{{ route('admin.applications.update', $application->id) }}"
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <select class="form-select border-end-0" name="business_entity" required>
                                    ...
                                    <option value="Partnership"
                                        {{ old('business_entity', $application->business_entity) == 'Partnership' ? 'selected' : '' }}>
                                        Partnership</option>
                                    <option value="Company"
                                        {{ old('business_entity', $application->business_entity) == 'Company' ? 'selected' : '' }}>
                                        Company</option>
                                </select>
                                <span class="icon-box border-start-0">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <select class="form-select border-end-0" name="business_nature" required>
                                    ...
                                    <option value="Manufacturing"
                                        {{ old('business_nature', $application->business_nature) == 'Manufacturing' ? 'selected' : '' }}>
                                        Manufacturing</option>
                                    <option value="Retail"
                                        {{ old('business_nature', $application->business_nature) == 'Retail' ? 'selected' : '' }}>
                                        Retail</option>
                                    <option value="Services"
                                        {{ old('business_nature', $application->business_nature) == 'Services' ? 'selected' : '' }}>
                                        Services</option>
                                </select>
                                <span class="icon-box border-start-0">
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <select class="form-select border-end-0" name="position" required>
                                    ...
                                    <option {{ (string) $appValue('position') === 'Director' ? 'selected' : '' }}>Director
                                    </option>
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input type="email" class="form-control border-end-0" name="email_address" required
                                    placeholder="Enter email" value="{{ $appValue('email_address') }}">
                                <span class="icon-box border-start-0">
                    ...
                    <div class="row g-3 align-items-center mb-2">
                        ...
                        <div class="col-md-4 d-flex align-items-center">
                            <input class="form-control border-end-0" name="service_type" readonly required placeholder=""
                    ...
                    <div class="row g-3 align-items-center mb-2">
                        ...
                        <div class="col-md-10 d-flex align-items-center">
                            <input class="form-control border-end-0" name="comment" placeholder="Enter your comments"
