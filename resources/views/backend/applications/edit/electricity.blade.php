        ...
        <div class="dashboard-main-body bg-light position-relative pt-5">
           ...
           @include('backend.layouts.partials.leads-sales-cards')
            ...
            <div class="container-fluid bg-white px-3 py-5">
                ...
                <form id="electricityForm" action="{{ route('admin.applications.update', $application->id) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="business_entity" required>
                                    <option disabled {{ $appValue('business_entity') ? '' : 'selected' }}>Please Select</option>
                                                                        <option  {{ (string) $appValue('business_entity') === 'Business' ? 'selected' : '' }}>Business</option>
                                    <option  {{ (string) $appValue('business_entity') === 'Individual' ? 'selected' : '' }}>Individual</option>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="title" required>
                                    ...
                                    <option {{ (string) $appValue('title') === 'Miss.' ? 'selected' : '' }}>Miss.</option>
                                </select>
                            </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="position" required>
                                    ...
                                    <option {{ (string) $appValue('position') === 'Employee' ? 'selected' : '' }}>Employee</option>
                                </select>
                            </div>
            ...
            <i class="bi bi-plus-circle me-1"></i> Add More Meter
                    ...
                    <div class="form-section mb-3">
                        ...
                        <div class="row gy-1 gx-3 align-items-center">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control" name="name_on_account" value="{{ $appValue('name_on_account') }}">
                                <span class="icon-box border-start-0"><i class="bi bi-person"></i></span>
                            </div>

                            <div class="col-md-2"><label>Account Number</label></div>
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control" name="account_number" value="{{ $appValue('account_number') }}">
                                <span class="icon-box border-start-0"><i class="bi bi-hash"></i></span>
                            </div>
                    ...
                    <div class="form-section mb-3">
                        ...
                        <div class="row gy-1 gx-3 align-items-center">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control" name="new_customer_name" required value="{{ $appValue('new_customer_name') }}">
                            </div>
                        </div>
