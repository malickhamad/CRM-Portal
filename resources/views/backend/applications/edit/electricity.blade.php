                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="application_agent" required>
                                    <option disabled {{ $appValue('application_agent') ? '' : 'selected' }}>Select Agent
                                    </option>
                                    <option
                                        {{ (string) $appValue('application_agent') === 'Ali Hassan' ? 'selected' : '' }}>Ali
                                        Hassan</option>
                                    <option
                                        {{ (string) $appValue('application_agent') === 'Usman Khan' ? 'selected' : '' }}>
                                        Usman Khan</option>
                                    <option
                                        {{ (string) $appValue('application_agent') === 'Sara Ahmed' ? 'selected' : '' }}>
                                        Sara Ahmed</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="business_entity" required>
                                    <option disabled {{ $appValue('business_entity') ? '' : 'selected' }}>Please Select
                                    </option>
                                    <option {{ (string) $appValue('business_entity') === 'Business' ? 'selected' : '' }}>
                                        Business</option>
                                    <option {{ (string) $appValue('business_entity') === 'Individual' ? 'selected' : '' }}>
                                        Individual</option>
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="business_nature" required
                                    value="{{ $appValue('business_nature') }}">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="merchant_full_name" required
                                    value="{{ $appValue('merchant_full_name') }}">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="position" required>
                                    ...
                                    <option {{ (string) $appValue('position') === 'Owner' ? 'selected' : '' }}>Owner
                                    </option>
                                    <option {{ (string) $appValue('position') === 'Manager' ? 'selected' : '' }}>Manager
                                    </option>
                                    <option {{ (string) $appValue('position') === 'Employee' ? 'selected' : '' }}>Employee
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="brand" required>
                                    ...
                                    <option {{ (string) $appValue('brand') === 'Verifone' ? 'selected' : '' }}>Verifone
                                    </option>
                                    <option {{ (string) $appValue('brand') === 'Ingenico' ? 'selected' : '' }}>Ingenico
                                    </option>
