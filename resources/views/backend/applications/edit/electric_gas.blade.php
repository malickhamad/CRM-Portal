            ...
            <div class="container-fluid bg-white px-3 py-5">
                ...
                <div class="mb-5  py-2 bg-white ">
                    ...
                    <h6 class="fw-bold mb-0 green_color">
                        <i class="bi bi-ui-checks-grid me-1"></i>Edit Application (Electric Gas)
                    </h6>
                </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <select class="form-select" name="business_entity" required>
                                    ...
                                    <option {{ (string) $appValue('business_entity') === 'Private Limited' ? 'selected' : '' }}>Private Limited</option>
                                    <option {{ (string) $appValue('business_entity') === 'Public Limited' ? 'selected' : '' }}>Public Limited</option>
                                    <option {{ (string) $appValue('business_entity') === 'Partnership' ? 'selected' : '' }}>Partnership</option>
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control border-end-0" name="business_nature" required value="{{ $appValue('business_nature') }}">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control border-end-0" name="merchant_full_name"
                                    required value="{{ $appValue('merchant_full_name') }}">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2 pb-2">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input type="text" class="form-control border-end-0" name="companies_house_number"
                                    required value="{{ $appValue('companies_house_number') }}">
                                <span class="icon-box border-start-0">
                                    <i class="bi bi-building"></i>
                                </span>
                            </div>
    ...
    value="{{ \Carbon\Carbon::parse($appValue('application_date'))->format('Y-m-d') }}" required>
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input type="text" class="form-control border-end-0" name="annual_consumption"
                                    required value="{{ $appValue('annual_consumption') }}">
                                <span class="icon-box border-start-0">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input type="text" class="form-control border-end-0" name="commercial_resident"
                                    required value="{{ $appValue('commercial_resident') }}">
                                <span class="icon-box border-start-0">
                                    <i class="bi bi-building"></i>
                                </span>
                            </div>
                        ...
                        <div class="row gy-1 gx-3 align-items-center">
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control border-end-0" placeholder="Enter Name On Account"
                                    name="name_on_account" value="{{ $appValue('name_on_account') }}">
                                <span class="icon-box border-start-0"><i class="bi bi-person"></i></span>
                            </div>
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control border-end-0" placeholder="Enter Account Number"
                                    name="account_number" value="{{ $appValue('account_number') }}">
                                <span class="icon-box border-start-0"><i class="bi bi-hash"></i></span>
                            </div>
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <input class="form-control border-end-0" placeholder="Enter Bank Name"
                                    name="name_of_bank" required value="{{ $appValue('name_of_bank') }}">
