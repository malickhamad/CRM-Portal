...
@endphp
            ...
            <div class="container-fluid bg-white px-3 py-5">
                ...
                <div class="mb-5  py-2 bg-white ">
                    ...
                    <h6 class="fw-bold mb-0 green_color">
                        <i class="bi bi-ui-checks-grid me-1"></i>Edit Application (Telecom)
                    </h6>
                </div>
                ...
                <form id="telecomForm" action="{{ route('admin.applications.update', $application->id) }}" method="POST"
    ...
    <div class="form-section mb-3">
        ...
        <div class="row g-3 align-items-center mb-2 pb-2">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="company_name" class="form-control border-end-0" placeholder="Enter company name" required value="{{ $appValue('company_name') }}">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="landline_no" class="form-control border-end-0" placeholder="Enter landline number" required value="{{ $appValue('landline_no') }}">
        ...
        <div class="row g-3 align-items-center mb-2 pb-2">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="contact_person_name" class="form-control border-end-0" placeholder="Enter person name" required value="{{ $appValue('contact_person_name') }}">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="company_reg_no" class="form-control border-end-0" placeholder="Enter company reg no" required value="{{ $appValue('company_reg_no') }}">
        ...
        <div class="row g-3 align-items-center mb-2 pb-2">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="business_address" class="form-control border-end-0" placeholder="Enter business address" required value="{{ $appValue('business_address') }}">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="email" name="email_address" class="form-control border-end-0" placeholder="example@email.com" required value="{{ $appValue('email_address') }}">
        ...
        <div class="row g-3 align-items-center mb-2 pb-2">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="unit" class="form-control border-end-0" placeholder="Enter unit" required value="{{ $appValue('unit') }}">
                <span class="icon-box border-start-0"><i class="bi bi-building"></i></span>
            </div>

            <div class="col-md-2"><label>Home Address <span class="text-danger">:*</span></label></div>
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="home_address" class="form-control border-end-0" placeholder="Enter home address" required value="{{ $appValue('home_address') }}">
    ...
    value="{{ \Carbon\Carbon::parse($appValue('director_dob_single'))->format('Y-m-d') }}" required>
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="mobile_no" class="form-control border-end-0" placeholder="03XXXXXXXXX" required value="{{ $appValue('mobile_no') }}">
                <span class="icon-box border-start-0"><i class="bi bi-telephone"></i></span>
            </div>
        </div>
    </div>
    ...
    <div class="form-section mb-3">
        ...
        <div class="row g-3 align-items-center mb-2">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="application_num" class="form-control border-end-0" readonly required value="{{ $appValue('application_num') }}">
                <span class="icon-box border-start-0"><i class="bi bi-hash"></i></span>
            </div>

            <div class="col-md-2"><label>Service</label></div>
            <div class="col-md-4 d-flex align-items-center">
                <input type="text" name="service_type" class="form-control border-end-0" readonly required value="{{ $appValue('service_type') }}">
    ...
    <div class="form-section mb-3">
        ...
        <div class="row gy-1 gx-3 align-items-center">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input class="form-control border-end-0" name="name_on_account" placeholder="Enter Name On Account" value="{{ $appValue('name_on_account') }}">
                <span class="icon-box border-start-0"><i class="bi bi-person"></i></span>
            </div>

            <div class="col-md-2"><label>Account Number</label></div>
            <div class="col-md-4 d-flex align-items-center">
                <input class="form-control border-end-0" name="account_number" placeholder="Enter Account Number" value="{{ $appValue('account_number') }}">
                <span class="icon-box border-start-0"><i class="bi bi-hash"></i></span>
            </div>

            <div class="col-md-2"><label>Sort Code</label></div>
            <div class="col-md-4 d-flex align-items-center">
                <input class="form-control border-end-0" name="sort_code" placeholder="Enter Sort Code" value="{{ $appValue('sort_code') }}">
                <span class="icon-box border-start-0"><i class="bi bi-diagram-3"></i></span>
            </div>

            <div class="col-md-2"><label>IBAN</label></div>
            <div class="col-md-4 d-flex align-items-center">
                <input class="form-control border-end-0" name="iban" placeholder="Enter IBAN" value="{{ $appValue('iban') }}">
            ...
            <div class="col-md-4 d-flex align-items-center">
                <input class="form-control border-end-0" name="name_of_bank" placeholder="Enter Bank Name" value="{{ $appValue('name_of_bank') }}">
                <span class="icon-box border-start-0"><i class="bi bi-building"></i></span>
            </div>
